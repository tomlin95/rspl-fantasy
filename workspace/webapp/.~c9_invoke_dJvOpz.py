...
def user_home(request):
    ...
    if request.method == 'POST':
       ...
       # return render(request, 'webapp/home.html')
        ...
        pr
        update_weekly_score( int(request.GET.get('user_id', '')))
        update_total_score( int(request.GET.get('user_id', '')))
...
def update_players_score(weekgiven):
    ...
    for match in matches:
        ...
        us = User.objects.create_user( username="whatever", email="whatever@some.com", password="password")
